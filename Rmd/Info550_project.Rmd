...
---
```{r}
here::i_am("Rmd/Info550_project.Rmd")
...
#### Create a search matrix that can perform an easy search of the films by specifying the genre present in our list so that we can see which genres this movie belongs to. 
```{r}
